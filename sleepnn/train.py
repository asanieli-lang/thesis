...
def compute_class_weights(train_labels, num_classes=3):
    """
    Calculate class weights based on frequency in dataset.
...
def main():
    ...
    print("Model weights saved to outputs/sleep_cnn_weights.pth")
    ...
    print("Training history saved to outputs/loss_history.csv")
    ...
    print("Training plots saved to outputs/training_metrics.png")
